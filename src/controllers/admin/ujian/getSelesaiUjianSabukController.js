...
exports.getSelesaiUjianSabuk = async (req, res) => {
  try {
    ...
    let where = ["status = 'selesai'", "deleted_at IS NULL"];
    let params = [];
    ...
    return res.status(200).json({
      message: "Berhasil mengambil data ujian yang telah selesai",
      pagination: {
        current_page: page,
        per_page: limit,
    ...
    return res.status(500).json({
      message: "Gagal mengambil data ujian selesai",
      error: error.message,
    });
  }
};
